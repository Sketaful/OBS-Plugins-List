...
<details>
<summary>Gradient Source</summary>  
...
<details>
<summary>OBS Shader Filter</summary>  
...
* QAU provides three different dock types: Manual, Dynamic, and Search.  
* It also enables a hotkey quick search pop-up, giving you access to all of your sources at a key-stroke.  
* Docked sources have fast-access options for source properties, filters, and a list of all parent scenes.  
* All sources also have a context menu with commonly used tools such as rename, add to scene, and even integration with third party plugins like source clone.  
...
* Direct OBS integration, no need for separate client software.
* You can connect multiple devices at the same time, using WiFi or USB*.
* Free unlimited usage at standard definition (640x480), including sound and picture.
* Up to 1080p60 or 4k30* video, and 48kHz stereo audio (on supported devices).
* DSLR -like features including exposure, white balance, and focus controls.
* Use Ultrawide and Telephoto lenses on supported devices.
* Remote camera controls via custom browser dock in OBS Studio.
* In-app Pro upgrade unlocks all features and helps support the app.
* Minimalistic, simple, and efficient.  
